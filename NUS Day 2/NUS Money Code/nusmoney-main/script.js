...
//put all id into a variable in memory for easy access later.
...
//2 Add transaction datas to HTML browser DOM list
function addTransactionDOM(transaction) {
  const deposit_item = document.createElement('li');

  deposit_item.classList.add('plus');         //this creates the green border to show positive
  ...
  loan_item.classList.add('minus');          //this creates the red border to show negative
...
//3  Calculate the Balance, Deposit and Loan
...
function init() {
  ...
  TransactionDataAll.forEach(addTransactionDOM);   //calls 2, 
