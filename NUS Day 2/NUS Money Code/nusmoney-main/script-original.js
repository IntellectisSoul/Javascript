...
const money_plus = document.getElementById('deposit'); //deposit
const money_minus = document.getElementById('loan');    //loan
...
init();       // calling .js from within Javascript (instead of from HTML)
